...
<table width="90%" border="0" cellspacing="1" cellpadding="6">
  ...
  <tr>
    <td bgcolor="#EEEEEE">貨品名稱　
        <input name="name" type="text" id="name" value="<?php echo $record[chr_name];?>" size="50"></td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">編　號　　
        <input name="no" type="text" id="no" value="<?php echo $record[chr_no];?>" size="5" maxlength="6" onKeyDown="return isNumber(event);"></td>
  </tr>
  <tr>
...
<?php } ?>
  ...
  <tr>
    <td bgcolor="#EEEEEE">價　錢　＄
        <input name="price" type="text" id="price" value="0.00" size="5" maxlength="8" onKeyDown="return isPrice(this, event);"></td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">單位數量　
        <input name="base" type="text" id="base" value="1" size="5" maxlength="3" onKeyDown="return isNumber(event);"></td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">最低消費　
        <input name="min" type="text" id="min" value="1" size="5" maxlength="3" onKeyDown="return isNumber(event);">　
		※ 最低消費不能少於單位數量
	</td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">截單日期　
        <input name="phase" type="text" id="phase" value="1" size="5" maxlength="4" onKeyDown="return isNumber(event);">　
		※ 最少一天
	</td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">截單時間　
        <input name="cuttime" type="text" id="cuttime" value="0000" size="5" maxlength="4" onKeyDown="return isNumber(event);">　
		※ 0000 - 2359 （24小時制）
	</td>
  </tr>
  ...
  <tr>
    <td bgcolor="#EEEEEE">狀　態　　
		...
		<input name="status" type="radio" id="status" value="3" ><span style="color:#D7710D"> 新　貨　　　</span>
		<input name="status" type="radio" id="status" value="5" ><span style="color:#008081"> 季節貨　　　</span>
		<input name="status" type="radio" id="status" value="2" ><span style="color:#FF0000"> 暫　停　　　</span>
	</td>
  </tr>
...
<?php } ?>
  ...
  <tr>
    <td bgcolor="#EEEEEE">價　錢　＄
        <input name="price" type="text" id="price" value="<?php echo $record[int_default_price];?>" size="5" maxlength="8" onKeyDown="return isPrice(this, event);"></td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">單位數量　
        <input name="base" type="text" id="base" value="<?php echo $record[int_base];?>" size="5" maxlength="3" onKeyDown="return isNumber(event);"></td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">最低消費　
        <input name="min" type="text" id="min" value="<?php echo $record[int_min];?>" size="5" maxlength="3" onKeyDown="return isNumber(event);">　
		※ 最低消費不能少於單位數量
	</td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">截單日期　
        <input name="phase" type="text" id="phase" value="<?php echo $record[int_phase];?>" size="5" maxlength="4" onKeyDown="return isNumber(event);">　
		※ 最少一天
	</td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">截單時間　
        <input name="cuttime" type="text" id="cuttime" value="<?php echo $record[chr_cuttime];?>" size="5" maxlength="4" onKeyDown="return isNumber(event);">　
		※ 0000 - 2359 （24小時制）
	</td>
  </tr>
  ...
  <tr>
    <td bgcolor="#EEEEEE">狀　態　　
        <input name="status" type="radio" id="status" value="1" <?php if($record[status] == 1) echo "checked"; ?>><span style="color:#00356B"> 現　貨　　　</span>
		<input name="status" type="radio" id="status" value="3" <?php if($record[status] == 3) echo "checked"; ?>><span style="color:#D7710D"> 新　貨　　　</span>
		<input name="status" type="radio" id="status" value="5" <?php if($record[status] == 5) echo "checked"; ?>><span style="color:#008081"> 季節貨　　　</span>
		<input name="status" type="radio" id="status" value="2" <?php if($record[status] == 2) echo "checked"; ?>><span style="color:#FF0000"> 暫　停　　　</span>
	</td>
  </tr>
