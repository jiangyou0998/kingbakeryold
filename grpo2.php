                            ...
                            <td width="394px" align="center" bgcolor="#FFFFFF">
								...
								<span style="width:50px; display:inline-block; text-align:right;"
									...
									<?= number_format($row[totalqty], 0, '.', ',') ?>
                                        ...
                                        <? //=$itemID?><!--]['R']"-->
                                        <!--                                       data-mysqlid="-->
                                        <? //=($row[qty][R][mysqlid])? $row[qty][R][mysqlid] : ''?><!--"-->
                                        <!--                                       data-price="-->
                                        <? //=$row[price]?><!--"-->
                                        <!--                                       data-dept="R"-->
                                        <!--                                       data-id="--><? //=$itemID?><!--"-->
                                        <!--                                       value="-->
                                        <? //=($row[qty][R][qty])? number_format($row[qty][R][qty], 0, '.', ',') : '0'?><!--"-->
                                        ...
                                        <!--                                       data-id="--><? //=$itemID?><!--"-->
                                        <!--                                       value="-->
                                        <? //=($row[qty][B][qty])? number_format($row[qty][B][qty], 0, '.', ',') : '0'?><!--"-->
                                        <!--                                       class="dept-input" type="text" autocomplete="off" style="width:95%; margin:auto;"/>-->
                                        <!--							  </td>-->
                                        <!--							  <td width="19%" align="center">-->
                                        <!--								<input name="item[-->
                                        ...
                                        <!--                                       data-id="--><? //=$itemID?><!--"-->
                                        <!--                                       value="-->
                                        <? //=($row[qty][K][qty])? number_format($row[qty][K][qty], 0, '.', ',') : '0'?><!--"-->
                                        <!--                                       class="dept-input" type="text" autocomplete="off" style="width:95%; margin:auto;"/>-->
                                        <!--							  </td>-->
                                        <!--							  <td width="19%" align="center">-->
                                        <!--								<input name="item[-->
                                        ...
                                        <!--                                       data-id="--><? //=$itemID?><!--"-->
                                        <!--                                       value="-->
                                        <? //=($row[qty][F][qty])? number_format($row[qty][F][qty], 0, '.', ',') : '0'?><!--"-->
                                        <!--                                       class="dept-input" type="text" autocomplete="off" style="width:95%; margin:auto;"/>-->
                                        <!--							  </td>-->
                                    </tr>
                                    </tbody>
