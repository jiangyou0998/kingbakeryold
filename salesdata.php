...
<table border="1" width="800px" cellpadding="24">
		...
		<td colspan="2" style="padding:4px;">
			...
			?>
				<tr>
					...
					<td style="padding:8px"><input name="salesdata[<?=$record[int_id]?>]" type="number" value="<?=$record[int_price]?$record[int_price]:"0.00"?>" step="any" style="text-align:right;" onfocus="this.select();"/></td>
				</tr>
			<?php } ?>
			</table>
		</td>
	...
	<tr>
		<td colspan="2" align="center" style="padding:8px;"><input type="submit" value="提交" style="font-size:24px;padding:4px 18px;"/></td>
	</tr>
</table>
</form>
<?php } ?>
