...
<!--                刪除-->
                <td><img src="images/delete_2.png" onclick="deletereport(<?=$value[int_id]?>)" style="cursor:pointer;"></td>
            </tr>
			<?php } ?>
			</form>
		</table>
        <div><span>報表時間:</span>
            <select name="reporttime" id="reporttime">
                <option value="0" <?php if($_REQUEST[cat]=="0") {echo "selected";} ?>>請選擇時間</option>
                <?php
