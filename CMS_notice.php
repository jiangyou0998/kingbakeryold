    ...
    while ($record = mysqli_fetch_array($result)) {
        ...
        <tr>
            ...
            <td width="27%" align="left"
                bgcolor="<?php echo $bg; ?>"><?php if ($record[1] == "") echo "---"; else echo $record[1]; ?></td>
            <td width="31%" align="left"
                bgcolor="<?php echo $bg; ?>"><?php if ($record[3] == "") echo "---"; else echo $record[3]; ?></td>
            <td width="31%" align="left"
                bgcolor="<?php echo $bg; ?>"><?php if ($record['first_path'] == "") echo "---"; else echo ' <a href="notice/' . $record['first_path'] . '" target="_blank">' . $record['first_path'] . '</a>'; ?></td>
            <td width="10%" align="left" bgcolor="<?php echo $bg; ?>">
                ...
                <?php if ($record[1] == "") { ?>
                    <input name="upload" type="button" id="upload" value="上載"
                           onClick="location.href='CMS_notice_2.php?action=upload&intid=<?php echo $record[0]; ?>&intno=<?php echo $record[8]; ?>'">
                <?php } else echo "&nbsp;"; ?></td>
        </tr>
        <?php
    }
