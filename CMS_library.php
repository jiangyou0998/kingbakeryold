...
<head>
    ...
    <script language="javascript">
        ...
        function subcheck() {
            ...
            for (var i = 1; i <= j; i++) {
                if (document.getElementById("txt_p_name" + i) == null) {
                    continue;
                }
            ...
            if (bool == false) {
                document.getElementById("errorDiv").innerHTML = "請完整錄入圖書信息,所有項必填！" + temp_txt;
            }
            return bool;
        }
...
<br><br>
<div align="center">
    <form action="CMS_library_do.php?action=AddLibrary" enctype="multipart/form-data" onSubmit="return subcheck()"
          method="post" name="form1">
        <table width="530" height="287" border="1">
            <tr>
                <td height="50" colspan="3" align="center">上傳圖書
                    <!--<font color="#FF0000" size="+3">(維護中，暫停使用)</font>--></td>
            </tr>
            <tr>
                ...
                <td valign="top">
                    <table id="MyTable" width="100%" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr bgcolor="#EAEAEA">
                            ...
                            <td align="center" width="13%"><input type=button value="添加" name"addfieldbt"
                                onclick="AddRow();"/>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                ...
                <td valign="top">
                    <table id="MyFile" width="100%" border="0" cellpadding="0" cellspacing="0"
                           style="text-align:center">
                        <tr bgcolor="#EAEAEA">
                            <td align="center" width="29%">名稱</td>
                            <td align="center" width="58%">地址</td>
                            <td align="center" width="13%"><input type=button value="添加" name"addfile"
                                onclick="MyRow();"/>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                ...
                <td>
                    <div id="other">
                        ...
                        <input id="dept" type="checkbox" name="dept" value="<?= $_SESSION['dept']; ?>"
                               onClick="selectRow()">部門專屬
                    </div>
