...
function check_sub()
{
	...
	{
		alert("日期輸入有誤");return false;
	}
	if(name.length==0|| lasttime.length==0 || fileurl.length==0)
	{
		alert("資料尚未錄入完整");return false;
	}
	
	else if(changeType(fileurl))
	{
		alert("顯示文檔只能為PDF文檔！");return false;
	}
	else
	{
		return true;
...
<tr>
	<td>到期時間：</td>
    <td>
		<input name="txt_last_time" type="text" id="txt_last_time" size="26" onClick="WdatePicker({dateFmt:'yyyy/MM/dd'})" readonly>
...
<tr>
	<td colspan="2"><input name="notice" type="file" id="notice" size="28" accept="application/pdf"  single /></td>
</tr>
...
<p>上傳檔案請按<font style="color:#F00; font-size:16px"><B>一次</B></font>&quot;提交&quot;按鈕便可。 <font style="color:#F00; font-size:16px"><B>請勿按多過一次&quot;提交&quot;</B></font>, 因為上傳檔案大小會影響上傳時間。 請&quot;提交&quot;後耐心等候上傳完成。上傳時間大慨2-3分鐘。<br>
