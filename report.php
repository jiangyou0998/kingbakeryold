...
<div align="center" style="width:995px;" class="row">
    <div class="col-sm-4">
        <a href="lawEnforcementAgencyRecord_main.php?head=12"><img src="images/report_law.jpg" alt="執法部門巡查執告"
                                                                   width="150" height="150" border="0"></a>
    </div>
    <div class="col-sm-4">
        <a href="itsupport.php?head=12"><img src="images/report_it.jpg" alt="IT求助報告" width="150" height="150"
                                             border="0"></a>
    </div>
    <div class="col-sm-4">
        <a href="repair_project.php?head=12"><img src="images/report_PED.jpg" alt="維修項目報告" width="150" height="150"
                                                  border="0"></a>
    </div>
</div>
<br/>
