...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr>
        <td>
            ...
            <div id="class02ParentUltraDev" onClick="javascript:hideshow('class02ChildUltraDev')" class="exheading">設定
            </div>
            ...
            <div id="class02ParentApplication" onClick="javascript:hideshow('class02ChildApplication')"
                 class="exheading">報表
            </div>
