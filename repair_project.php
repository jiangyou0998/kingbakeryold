...
<style type="text/css">
	...
	input[disabled]{ background-color: #7F7F7F !important; }
</style>
...
<form enctype="multipart/form-data" name="form_CaseInsert" id="form" action="repair_project.php" method="post" onSubmit="return confInsertSubmit();">

<table border="1" style="border-collapse:collapse;" borderColor="#ccc" cellspacing="0" cellpadding="0" width="994px">
...
<table width="994px" border="1" style="border-collapse:collapse;" borderColor="#ccc" cellspacing="0" cellpadding="0">
...
?>
	...
	<tr bgcolor="<?=$bgcolor;?>">
		...
		<td chr_remarks='<?=$project[chr_other]?>' onMouseOver="var _a = popupPanel(this); overlib(_a,FULLHTML,HAUTO,OFFSETX, 0,OFFSETY, -10,FOLLOWMOUSE,'off');" target="leftFrame">
        ...
        <td bgcolor="<?=$bgcolor;?>">
			<table>
				<tr><?php if(TRIM($project[chr_pic]) != '') {?>
					<td align="right">1:</td>
					<td align="left"><a href="repairproject/<?=$project[chr_pic];?>" target="_blank"><?="附檔</a></td>";}?></tr>
		...
		<td align="center" style="padding:5px;">		
			...
			<button type="button" onclick="_func_show('<?=$project[pj_id]?>', '1')" style="background-color:#ADFFAD;">補充資料</button>
			<?php } ?>
			
			
			<button type="button" onclick="_func_delete('<?=$project[pj_id]?>', '<?=$project[chr_no]?>');" style="background-color:#FFADAD;">刪除</button>
		</td>
	...
	<tr bgcolor="<?=$bgcolor;?>">
        ...
        <td bgcolor="<?=$bgcolor;?>">
			<table>
				<tr><?php if(TRIM($project[chr_pic]) != '') {?>
					<td align="right">1:</td>
					<td align="left"><a href="repairproject/<?=$project[chr_pic];?>" target="_blank"><?="附檔</a></td>";}?>
				</tr>
			</table>        
		</td>
		<td align="center" style="padding:5px;">		
			<button type="button" onclick="_func_show('<?=$project[pj_id]?>', '2')" style="background-color:#FFFFAD;">跟進資料</button>
		</td>
	</tr>
<?php $recordCount ++;}?>	
</table>
