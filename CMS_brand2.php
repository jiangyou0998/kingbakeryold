...
<table width="90%" border="0" cellspacing="1" cellpadding="6">
  <tr>
    <td bgcolor="#EB8201"><span class="style1">設定 &gt; 品牌 &gt; 新增</span></td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">品牌名稱　
...
<?php
    break;
    case "edit":
		$sql = "SELECT int_id,chr_name,int_sort
		FROM tbl_order_z_area
...
<table width="90%" border="0" cellspacing="1" cellpadding="6">
  <tr>
    <td bgcolor="#EB8201"><span class="style1">設定 &gt; 品牌 &gt; 修改</span></td>
  </tr>
  <tr>
    <td bgcolor="#EEEEEE">品牌名稱　
...
<?php
    break;
    case "delete":
      $sql = "UPDATE tbl_order_z_area SET bl_isvalid = '0' ";
      $sql .= "WHERE int_id = '$_REQUEST[id]' ";
      mysqli_query($con, $sql) or die($sql);
    break;
    case "add":
	  $sql = "INSERT INTO tbl_order_z_area(chr_name, int_sort) VALUE('$_REQUEST[name]','$_REQUEST[sorting]');";
      mysqli_query($con, $sql) or die($sql);
		break;
    case "confirm":
	  
	  $sql = "UPDATE tbl_order_z_area SET ";
...
?>
  <table width="90%" border="0" cellspacing="1" cellpadding="6">
    <tr>
      <td bgcolor="#EB8201"><span class="style1">設定 &gt; 品牌 &gt; 完成</span></td>
    </tr>
    <tr>
      <td height="100" align="center" bgcolor="#EEEEEE"><a href="CMS_brand.php">更新完成</a></td>
    </tr>
  </table>
<?php
  }
