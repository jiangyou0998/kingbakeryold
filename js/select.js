...
(function($){
	var item,menu,timer,options = null,type = 'select';
	...
	*/
	...
	/**
			根據CODE 獲取數據
	*/
	function ShopBind(code, options){
		var isAjax = true;
		item.find('li').hide();
		item.find('li').each(function(){
	...
	*/
	...
	/**
		區域項目事件綁定
	*/
	function AreaBindClick(options){
