...
<body>
<form name="form_CaseUpdate" id="form" enctype="multipart/form-data"
      action="lawEnforcementAgencyRecord_additional_utf_8.php?id=<?= $_GET["id"] ?>" method="post"
    ...
    if (mysqli_num_rows($result_Notcomplete) == 0) {
        echo "<center><font size=5 color=red>沒有紀錄 !!</font></center>";
    } else {
    ?>
...
//		if($recordCount > 1) { echo "<tr><td width=\"100%\" colspan=\"10\" bgcolor=\"#FFFF00\">&nbsp;</td></tr>";}
            ...
            <input type="hidden" id="update_ptDate" name="update_ptDate"
                   value="<?= $record_Notcomplete[date_penalty_ticket] ?>"/>
            <input type="hidden" id="update_ptNum" name="update_ptNum"
                   value="<?= $record_Notcomplete[chr_penalty_no] ?>"/>
            <input type="hidden" id="update_pAmt" name="update_pAmt"
                   value="<?= $record_Notcomplete[decimal_penalty_amount] ?>"/>
            <input type="hidden" id="updateCheck" name="updateCheck" value="1"/>

            <input type="hidden" id="update_counter" name="update_counter"
                   value="<?= ord($record_Notcomplete[bool_counter]) ?>"/>
            ...
            <tr>
                ...
                <td>
                    <table width="200xp" style="border-top:1px solid #ccc;">
                        <tr>
                            <?
                            ...
                            <td align="left"><a
                                    ...
                                    ?>
                            <td align="right" <?= TRIM($record_Notcomplete[chr_file_name_1]) != '' ? 'style="display: none"' : ' ' ?> >
                                1:
                            </td>
                            <td align="left" <?= TRIM($record_Notcomplete[chr_file_name_1]) != '' ? 'style="display: none"' : '' ?> >
                                <div id="div_file1" style="float:left">
                                    ...
                                    <input type="button" id="btnFile1" name="btnFile1" style="width:105"
                                           value="特別事項報告"/>
                                </div>
                                <div style="float:left"><input type="button" id="clear1" name="clear1"
                                                               onClick="clearFileInputField('1');" value="清除"/></div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left"><a
                                    ...
                                    ?>
                            <td align="right" <?= TRIM($record_Notcomplete[chr_file_name_2]) != '' ? 'style="display: none"' : '' ?> >
                                2:
                            </td>
                            <td align="left" <?= TRIM($record_Notcomplete[chr_file_name_2]) != '' ? 'style="display: none"' : '' ?> >
                                <div id="div_file2" style="float:left">
                                    <input id="file2" name="uploadfile[]" type="file" onChange="upFile('2');"
                                           style="position:absolute;filter:alpha(opacity=0);  -moz-opacity:0;         /*火狐*/opacity:0;  width:105px;"/>
                                    <input type="button" id="btnFile2" name="btnFile2" style="width:105" value="相片1"/>
                                </div>
                                <div style="float:left"><input type="button" id="clear2" name="clear2"
                                                               onClick="clearFileInputField('2');" value="清除"/></div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left"><a
                                    ...
                                    ?>
                            <td align="right" <?= TRIM($record_Notcomplete[chr_file_name_3]) != '' ? 'style="display: none"' : '' ?> >
                                3:
                            </td>
                            <td align="left" <?= TRIM($record_Notcomplete[chr_file_name_3]) != '' ? 'style="display: none"' : '' ?> >
                                <div id="div_file3" style="float:left">
                                    <input id="file3" name="uploadfile[]" type="file" onChange="upFile('3');"
                                           style="position:absolute;filter:alpha(opacity=0);  -moz-opacity:0;         /*火狐*/opacity:0;  width:105px;"/>
                                    <input type="button" id="btnFile3" name="btnFile3" style="width:105" value="相片2"/>
                                </div>
                                <div style="float:left"><input type="button" id="clear3" name="clear3"
                                                               onClick="clearFileInputField('3');" value="清除"/></div>
                            </td>
                        </tr>
                        <tr>
                            <?
                            ...
                            <td align="left"><a
                                    ...
                                    ?>
                            <td align="right" <?= TRIM($record_Notcomplete[chr_file_name_4]) != '' ? 'style="display: none"' : '' ?> >
                                4:
                            </td>
                            <td align="left" <?= TRIM($record_Notcomplete[chr_file_name_4]) != '' ? 'style="display: none"' : '' ?> >
                                <div id="div_file4" style="float:left">
                                    <input id="file4" name="uploadfile[]" type="file" onChange="upFile('4');"
                                           style="position:absolute;filter:alpha(opacity=0);  -moz-opacity:0;         /*火狐*/opacity:0;  width:105px;"/>
                                    <input type="button" id="btnFile4" name="btnFile4" style="width:105" value="相片3"/>
                                </div>
                                <div style="float:left"><input type="button" id="clear4" name="clear4"
                                                               onClick="clearFileInputField('4');" value="清除"/></div>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (ord($record_Notcomplete["bool_end"]) == 1) {
                            ...
                            ?>
                            <input name="cb_end" id="cb_end"
                                   type="checkbox" <?= ord($record_Notcomplete["bool_end"]) == 1 ? "checked" : "" ?>
                                   value="">
                            <?
                        }
                        ?>
