...
$sql .= "(SELECT o.int_user, sum(ifnull(o.int_qty_received,o.int_qty)) as int_qty, i.chr_no FROM tbl_order_z_dept o LEFT JOIN tbl_order_z_menu i ";
$sql .= "ON o.int_product = i.int_id WHERE i.chr_no in ($code) AND DATE(DATE_ADD(o.insert_date, INTERVAL 1+o.chr_phase DAY)) = '$deli_date' ";
                    ...
                    if($count % 13 == 1 ){
                        ...
                        <table border="1" cellpadding="0" cellspacing="0">
                            <tr bgcolor="#CCFFFF">
                                ...
                                <?php
                                    //表頭分店名
                                    foreach ($Page[$pageCount] as $headerKey => $headerValue) { ?>
                                    <td align="center" style="width:85px"><strong><?= $product[$headerValue][txt_name] ?></strong></td>
                                    <?php } ?>
                                </tr>
            <?php
                    }
