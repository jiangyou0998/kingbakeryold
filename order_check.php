...
<div align="center" style="width:995px;">
    ...
    <div align="center" style="width:100%;margin:auto;">
        <b>送貨日期： </b>
        <input type="text" class="form-control" value="<?= $search_date ?>" id="datepicker"
               onclick="WdatePicker({isShowClear:false})" style="width:125px" readonly>
                                ...
                                <table class="cssTable1">
                                    <tr class="style7">
                                        <th colspan="7">
                                            ...
                                            PO#<?= Date("y", $timestamp) ?>A<?= str_pad($po, 6, '0', STR_PAD_LEFT) ?>
                                            - <?= $po_detail[order_time] ?>
                                        </th>
                                    </tr>
                                    <tr class="style6">
                                        <th>項目</th>
