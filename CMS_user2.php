...
switch ($_REQUEST[action]) {
            ...
            <table width="90%" border="0" cellspacing="1" cellpadding="6">
                ...
                <tr>
                    <td bgcolor="#EEEEEE">帳戶名稱　
                        <input name="name" type="text" id="name" value="<?php echo $record[txt_name]; ?>" size="50">
                    </td>
                </tr>
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">報表名稱　
                        <input name="reportName" type="text" id="reportName"
                               value="<?php echo $record[chr_report_name]; ?>" size="50"></td>
                </tr>
                <tr>
                    <td bgcolor="#EEEEEE">登入名稱　
                        <input name="login" type="text" id="login" value="<?php echo $record[txt_login]; ?>" size="50">
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#EEEEEE">電子郵件　
                        <input name="email" type="text" id="name" value="<?php echo $record[chr_email]; ?>" size="50">
                    </td>
                </tr>
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">分店編號　
                        <input name="code" type="text" id="name" value="<?php echo $record[chr_ename]; ?>" size="50">
                    </td>
                </tr>
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                ...
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">電話　　　
                        <input name="tel" type="text" id="name" value="<?php echo $record[chr_ename]; ?>" size="50">
                    </td>
                </tr>
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                ...
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">英文地址　
                        <input name="addr2" type="text" id="name" value="<?php echo $record[chr_ename]; ?>" size="50">
                    </td>
                </tr>
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">營業時間　
                        <input name="oper_time" type="text" id="name" value="<?php echo $record[chr_oper_time]; ?>"
                               size="50"></td>
                </tr>
            ...
            <table width="90%" border="0" cellspacing="1" cellpadding="6">
                ...
                <tr>
                    <td bgcolor="#EEEEEE">登入密碼　
                        <button type="button" onclick="location='CMS_user2.php?id=<?= $record[int_id] ?>&action=pwd';">
                            重設密碼
                        </button>
                    </td>
                </tr>
  ...
  WHERE T0.int_id = $record[int_district]";
                ...
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">中文地址　
                        <input name="addr1" type="text" id="name" value="<?php echo $dis[chr_address]; ?>" size="50">
                    </td>
                </tr>
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">英文地址　
                        <input name="addr2" type="text" id="name" value="<?php echo $dis[chr_eng_address]; ?>"
                               size="50"></td>
                </tr>
                <tr class="tr-shop" <?php if ($record[chr_type] == 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">營業時間　
                        <input name="oper_time" type="text" id="name" value="<?php echo $dis[chr_oper_time]; ?>"
                               size="50"></td>
                </tr>
                <tr class="tr-user" <?php if ($record[chr_type] <> 2) echo "style='display:table-row;'"; ?>>
                    <td bgcolor="#EEEEEE">部　　門　
...
IF (($_REQUEST[action] <> "new") AND ($_REQUEST[action] <> "edit")) {
    ...
    <table width="90%" border="0" cellspacing="1" cellpadding="6">
        ...
        <tr>
            <td height="100" align="center" bgcolor="#EEEEEE"><a
                        href="CMS_user.php?type=<?= $_REQUEST[type] ?>">更新完成</a></td>
        </tr>
    </table>
    <?php
}
