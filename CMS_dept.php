...
?>
  <tr>
    ...
    <td width="40" align="center" bgcolor="<?php echo $bg;?>"><a href="CMS_dept2.php?action=edit&id=<?php echo $record[int_id];?>">更新</a></td>
    <td width="40" align="center" bgcolor="<?php echo $bg;?>"><a href="CMS_dept2.php?action=delete&id=<?php echo $record[int_id];?>">刪除</a></td>
  </tr>
<?php
    $count += 1;
  }
