...
$sql = "SELECT distinct tbl_user.txt_name as 'shop_name',tbl_user.txt_login as 'shop_accout', DATE(DATE_ADD(tbl_order_z_dept.order_date, INTERVAL 1+tbl_order_z_dept.chr_phase DAY)) as 'deli_date' , count(*) as 'item_count'
    ...
    LEFT JOIN tbl_order_z_menu on tbl_order_z_dept.int_product = tbl_order_z_menu.int_id
    LEFT JOIN tbl_order_z_group on tbl_order_z_menu.int_group = tbl_order_z_group.int_id
    LEFT JOIN tbl_order_z_cat on tbl_order_z_group.int_cat = tbl_order_z_cat.int_id
