		 ...
		 <table class="item" width="100%" >
			...
			<tr>
				<td style="height:20px; width:50%; font-size:24px; text-align:center" colspan="2">
					...
					<a id="itm-<?=$record['itemID']?>" href="#" onclick="add(<?= $record['itemID'];?>,<?= $record['chr_no'];?>,'<?= $record['suppName'];?>','<?= $record['itemName'];?>','<?= $record['UoM'];?>',<?= $record['int_base'];?>,<?= $record['int_min'];?>,<?= $overTime;?>)">
				...
				<td style="height:20px; width:50%; text-align:center" colspan="2">
					<a id="itm-<?=$record['itemID']?>"  href="#" onclick="drop(<?= $record['chr_no'];?>,<?= $record['int_base'];?>,<?= $record['int_min'];?>)" style="color:black;">
						<button type="button" style="height:100%; width:100%; font-size:18px;" <?=$disableButton?>>-</button>
					</a>
				</td>
			</tr>
