...
use PHPMailer\PHPMailer\Exception;
	...
	$sql = "SELECT int_report_id, chr_report_name, chr_time 
			...
			WHERE T1.disabled = 0 AND chr_time = '10:00' AND chr_weekday LIKE CONCAT('%', WEEKDAY(CURDATE()), '%');";
...
EOT;
		...
		$mail->From = "jianli@kingbakery.com.hk";
		$mail->SMTPDebug = 1;
		$mail->AddAddress("jianli@kingbakery.com.hk");
		//$mail->AddBCC("yuecheung.lau@gmail.com");
		$mail->AddAttachment("order\\{$record[chr_report_name]}_{$date2}.pdf");
		$mail->CharSet="utf-8";
        ...
        $deli_date = date("Y-m-d H:i:s");
		$mail->Body    = "<h1>$record[chr_report_name]</h1>$deli_date<br>";
