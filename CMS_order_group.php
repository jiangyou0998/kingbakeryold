                    ...
                    <tr>
                        <td>
                            <select name="menu1" onChange="MM_jumpMenu('self',this,1)">
                                <option value="?cat=0" <?php if ($_REQUEST[cat] == "0") {
                                    echo "selected";
                                } ?>>請選擇大類
                                </option>
                                <?php
                            ...
                            <input name="Add" type="button" id="Add" value="新增細類"
                                   onClick="document.location.href='CMS_order_group2.php?action=new';">
                        </td>
        ...
        WHILE ($record = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td width="40" align="center" bgcolor="<?php echo $bg; ?>"><a
                            href="CMS_order_group2.php?action=edit&id=<?php echo $record[int_id]; ?>">更新</a></td>
                <td width="40" align="center" bgcolor="<?php echo $bg; ?>"><a
                            href="CMS_order_group2.php?action=delete&id=<?php echo $record[int_id]; ?>">刪除</a></td>
            </tr>
            <?php
            $count += 1;
        }
