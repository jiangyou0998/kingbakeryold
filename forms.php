...
<table id="Table_01" width="995" height="1148" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
	  ...
	  <td height="890" colspan="3" rowspan="6" align="left" valign="top" background="images/TaiHing_13.jpg"><table width="275" border="0" cellspacing="5" cellpadding="3">
          <tr>
...
?>
          <tr>
            <td align="left"><a href="?dept=<?=$record[0];?>&head=<?=$_REQUEST['head'];?>" class="SelectMenu"><?=$record[1];?></a></td>
          </tr>
<?php 
}
?>
...
?>
		  ...
		  <tr>
		    <td width="80" align="left"><span class="RightText RightText style18"><?=$record['date_modify'];?>&nbsp;</span></td>
            <td align="left"><span class="RightText RightText style18"><?=$record['int_no'];?>&nbsp;</span></td>
            <td align="left"><span class="RightText RightText style18"><a href="forms/<?=$record['txt_path'];?>" target="_blank"><?=$record['txt_name'];?>&nbsp;</a>
              <?php 
//$a = date_diff($record['date_modify'], date("Y-m-d"));
//if ($a[days_total] < 15) echo "<img src=\"images/news_a.gif\" width=\"32\" height=\"24\">";
?>
            </span></td>
            <td align="left"><span class="RightText RightText style18"><?=$record['txt_dept'];?></span></td>
            <td align="left"><input name="orderno" type="<?=$isMulti? "text":"hidden"?>" id="orderno" value="" size="4" maxlength="2"></td>
            <td align="left"><input name="Submit" type="<?=$isMulti? "submit":"hidden"?>" value="申請"></td>
