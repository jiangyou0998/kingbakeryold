		...
		<div style="width:993px; border:1px solid black; min-height:200px; margin:auto; margin-left:1%;">
			<table class="table1" id="GrpoData" cellspacing="0" cellpadding="0" style="width:993px; border-left:0px; border-right:0px; border-top:0px;">
				...
				<tr>
					...
					<td width="100px" align="center" bgcolor="#FFFFFF">
						<span style="width:50px; display:inline-block; text-align:right;" class="deli-qty" data-id="<?=$itemID?>">
							<?=number_format(array_sum($row[qty]), 0, '.', ',')?> 
						</span>
						<?=$row[unit]?>
					</td>
					<td width="100px" align="center" bgcolor="#FFFFFF">			
						<input type="text" value="<?=array_sum($row[qty])?>" class="dept-input" style="text-align:right; width:50px;"/>
						<?=$row[unit]?>
						<!--
