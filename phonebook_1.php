...
<style>
	#table01 { font-size:18px; }
	#table01 td, th { font-size:16px; }
</style>
<script>
function checkno() {
...
?>
          <tr>
            <td align="left"><a href="?area=<?=$record[0];?>&head=<?=$_REQUEST['head'];?>" class="SelectMenu"><?=$record[1];?></a></td>
          </tr>
<?php
}
?>
...
?>
		  <tr>
            ...
            <td align="center" style="padding:0px;">
				<table width="100%" height="100%">
					<tr>
						<th width="15%" align="left" valign="top" style="border-right:2px solid black;">中文地址</th>
		  ...
		  <tr>
		    <td align="center" style="padding:0px;">
				<table width="100%">
					<tr>
						<th width="15%" align="left" valign="top" style="border-right:2px solid black;">英文地址</th>
		...
		<tr>
			<td align="center" style="padding:0px;">
				<table width="100%">
					<tr>
						<th width="15%" align="left" valign="top" style="border-right:2px solid black;">營業時間</th>
