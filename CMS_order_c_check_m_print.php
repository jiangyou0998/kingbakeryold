...
<head>
	...
	<style>	
		...
		.data {max-height:32px; height:32px; min-height:32px; vertical-align:middle; padding:4px; }
...
<div class="page">
	...
	<table border="1" cellpadding="0" cellspacing="0">
		...
		<tr bgcolor="<?=$bg?>">
			...
			<td class="data style3" align="center" style="max-width:130px; min-width:130px; width:130px;"><?=$aryMenu[$key][chr_name]?></td>
			<td class="data style6" align="center" bgcolor="#FFFFCC">
				<?=$total[$aryMenu[$key][chr_no]] + 0?>
			</td>
			<?php foreach ($Page[$pageCount] as $shop) { ?>
				<td align="center" class="data style6" width="<?=$width?>"><?=$product[$shop][$aryMenu[$key][chr_no]]?></td>
			<?php } ?>
		</tr>
		<?php $count++; 
			} 
