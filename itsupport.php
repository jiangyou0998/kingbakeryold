...
<form enctype="multipart/form-data" name="form_CaseInsert" id="form" action="itsupport.php" method="post" onSubmit="return confInsertSubmit();">
        ...
        <td bgcolor="<?=$bgcolor;?>">
			<table>
				<tr><?php if(TRIM($project[chr_pic]) != '') {?>
					<td align="right">1:</td>
					<td align="left"><a href="itsupport/<?=$project[chr_pic];?>" target="_blank"><?="附檔</a></td>";}?></tr>
	...
	<tr bgcolor="<?=$bgcolor;?>">
        ...
        <td bgcolor="<?=$bgcolor;?>">
			<table>
				<tr><?php if(TRIM($project[chr_pic]) != '') {?>
					<td align="right">1:</td>
					<td align="left"><a href="itsupport/<?=$project[chr_pic];?>" target="_blank"><?="附檔</a></td>";}?>
				</tr>
			</table>        
		</td>
		<td align="center" style="padding:5px;">		
