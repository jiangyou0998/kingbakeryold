...
<table width="640" height="480" border="1" cellpadding="10" cellspacing="2">
	...
	ORDER BY tbl_order_z_dept.order_date DESC , 
			 ...
			 tbl_order_z_group.int_sort;";
                ...
                <tr>
                    <td colspan="3" valign="middle">分店：<?= $_SESSION[user] ?><br>柯打日期：<?= date('Y/n/j', $timestamp) ?>
                        <br>柯打合共：<?= $count; ?><br><strong><font size="+3"
                                                                 color="#FF0000">預落<?= $_SESSION['advance']; ?>天</font></strong>
                    </td>
                    <td colspan="2" align="right">
                        <a href="order_z_dept.php?advance=<?= $_SESSION[advance] ?>&dept=<?= $_SESSION[OrderDept] ?>"><img
                                    src="images/Amend.jpg" width="106" height="60" border="0"></a>
                        <a href="order_z_dept_3.php?dept=<?= $_REQUEST['dept'] ?>&advance=<?= $advance ?>"><img
                                    src="images/Confirm.jpg" width="106" height="60" border="0" class="style3"></a>
                    </td>

                </tr>
            </table>
            <p><?php if ($haveoutdate == 1) echo "<strong><u><font color='#FF0000' size='5'><img src='images/alert.jpg' width='20' height='20'>產品已截單，<br><img src='images/alert.jpg' width='20' height='20'>產品需自行致電貨倉落貨。</font></u></strong>"; ?>
                &nbsp;</p>
